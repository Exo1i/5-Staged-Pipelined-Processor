...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/clk
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/rst
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/in_port
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/out_port
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/out_port_en

add wave -divider "Fetch"
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/fetch_out.pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/fetch_out.pushed_pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/fetch_out.instruction

add wave -divider "IF/ID"
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/ifid_out.take_interrupt
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/ifid_out.override_operation
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/ifid_out.override_op
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/ifid_out.pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/ifid_out.pushed_pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/ifid_out.instruction

add wave -divider "Decode"
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.pushed_pc
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.opcode
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.operand_a
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.operand_b
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_out.immediate
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_out.rsrc1
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_out.rsrc2
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_out.rd

add wave -divider "Register File"
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/Ra
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/Rb
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/ReadDataA
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/ReadDataB
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/Rdst
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/WriteData
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/WriteEnable
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/decode_inst/reg_file_inst/registers

add wave -divider "Decode Ctrl"
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.OutBSelect
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.IsInterrupt
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.IsHardwareInterrupt
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.IsCall
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.IsReturn
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.decode_ctrl.IsReti
...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.execute_ctrl.ALU_Operation
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.execute_ctrl.ConditionalType
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.memory_ctrl.SP_Enable
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.memory_ctrl.SP_Function
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.memory_ctrl.SPtoMem
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.memory_ctrl.PassInterrupt
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/decode_ctrl_out.memory_ctrl.MemRead
...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/idex_ctrl_out.execute_ctrl.ALU_Operation
...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/execute_ctrl_out.m_memwrite
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/execute_ctrl_out.m_sptomem
...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/exmem_ctrl_out.memory_ctrl.SP_Enable
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/exmem_ctrl_out.memory_ctrl.SP_Function
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/exmem_ctrl_out.memory_ctrl.SPtoMem
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/exmem_ctrl_out.memory_ctrl.PassInterrupt
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/exmem_ctrl_out.memory_ctrl.FlagFromMem

add wave -divider "Memory Stage"
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/mem_stage_read_req
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/mem_stage_write_req
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/mem_stage_addr
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/mem_stage_wdata
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/mem_wb_data_comb.memory_data
...
add wave -divider "WB"
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/wb_out.reg_we
add wave -radix unsigned sim:/fetch_decode_execute_memory_writeback_top/wb_out.rdst
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/wb_out.data

add wave -divider "MEM/WB"
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/memwb_data.memory_data
...
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/pass_pc
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/front_enable
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/mem_addr_mux
add wave -radix hexadecimal sim:/fetch_decode_execute_memory_writeback_top/mem_wdata_mux
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/mem_read_mux
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/mem_write_mux
add wave -radix binary sim:/fetch_decode_execute_memory_writeback_top/mem_read_out
...
force -freeze sim:/fetch_decode_execute_memory_writeback_top/in_port 16#00000000 0
